...
describe('ProjectModalManager - Open Project Modal', () => {
    ...
    beforeEach(() => {
        ...
        mockState = {
            projects: [
                { id: '1', title: 'Test Project', description: 'Test', status: 'active', contexts: ['@work'] }
            ]
        };
...
describe('ProjectModalManager - Gantt Chart', () => {
    ...
    beforeEach(() => {
        ...
        mockApp = {
            tasks: [
                { id: 't1', title: 'Task 1', projectId: '1', completed: false, status: 'next', waitingForTaskIds: [] },
                { id: 't2', title: 'Task 2', projectId: '1', completed: false, status: 'next', waitingForTaskIds: ['t1'] }
            ]
        };
    ...
    describe('openGanttChart()', () => {
        test('should open gantt modal with project title', () => {
            ...
            expect(modal.classList.contains('active')).toBe(true);
            expect(document.getElementById('gantt-modal-title').textContent).toBe('Test Project - Gantt Chart');
        });
    });
...
describe('ProjectModalManager - Integration', () => {
    ...
    test('should handle complete project creation workflow', async () => {
        ...
        expect(mockApp.saveProjects).toHaveBeenCalled();
        expect(mockApp.showNotification).toHaveBeenCalledWith('Project "Complete Workflow Test" created');
    });
