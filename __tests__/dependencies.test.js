...
describe('Dependencies Visualization Feature - Comprehensive Tests', () => {
    ...
    describe('setupDependenciesVisualization()', () => {
        test('should add click listener to dependencies button', () => {
            const addEventListenerSpy = jest.spyOn(document.getElementById('btn-dependencies'), 'addEventListener');
        ...
        test('should add click listener to close button', () => {
            const addEventListenerSpy = jest.spyOn(document.getElementById('close-dependencies-modal'), 'addEventListener');
        ...
        test('should add click listeners to view toggle buttons', () => {
            const graphBtnSpy = jest.spyOn(document.getElementById('deps-view-graph'), 'addEventListener');
            const chainsBtnSpy = jest.spyOn(document.getElementById('deps-view-chains'), 'addEventListener');
            const criticalBtnSpy = jest.spyOn(document.getElementById('deps-view-critical'), 'addEventListener');
        ...
        test('should add change listener to project filter', () => {
            const addEventListenerSpy = jest.spyOn(document.getElementById('deps-filter-project'), 'addEventListener');
    ...
    describe('updateDepsViewButtons()', () => {
        ...
        test('should update button classes for graph view', () => {
            ...
            expect(document.getElementById('deps-view-graph').classList.contains('btn-primary')).toBe(true);
            expect(document.getElementById('deps-view-chains').classList.contains('btn-secondary')).toBe(true);
            expect(document.getElementById('deps-view-critical').classList.contains('btn-secondary')).toBe(true);
        });
        ...
        test('should update button classes for chains view', () => {
            ...
            expect(document.getElementById('deps-view-graph').classList.contains('btn-secondary')).toBe(true);
            expect(document.getElementById('deps-view-chains').classList.contains('btn-primary')).toBe(true);
            expect(document.getElementById('deps-view-critical').classList.contains('btn-secondary')).toBe(true);
        });
        ...
        test('should update button classes for critical view', () => {
            ...
            expect(document.getElementById('deps-view-graph').classList.contains('btn-secondary')).toBe(true);
            expect(document.getElementById('deps-view-chains').classList.contains('btn-secondary')).toBe(true);
            expect(document.getElementById('deps-view-critical').classList.contains('btn-primary')).toBe(true);
        });
    ...
    describe('getDependenciesTasks()', () => {
        ...
        test('should filter by project when projectId provided', () => {
            const task1 = new Task({ id: 'task-1', title: 'Task 1', projectId: 'proj-1', completed: false });
            const task2 = new Task({ id: 'task-2', title: 'Task 2', projectId: 'proj-2', completed: false });
            app.tasks.push(task1, task2);
    ...
    describe('updateDepsStats()', () => {
        test('should update statistics correctly', () => {
            const task1 = new Task({ id: 'task-1', title: 'Task 1', completed: false });
            const task2 = new Task({ id: 'task-2', title: 'Task 2', completed: false, waitingForTaskIds: ['task-1'] });
            const task3 = new Task({ id: 'task-3', title: 'Task 3', completed: false, waitingForTaskIds: ['task-1'] });
    ...
    describe('calculateTaskLevel()', () => {
        ...
        test('should handle missing dependencies', () => {
            const task = new Task({ id: 'task-1', title: 'Task 1', waitingForTaskIds: ['non-existent'] });
    ...
    describe('Edge Cases', () => {
        ...
        test('should handle missing dependency tasks', () => {
            const task1 = new Task({ id: 'task-1', title: 'Task 1', waitingForTaskIds: ['missing-task'] });
            app.tasks.push(task1);
