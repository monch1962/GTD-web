...
describe('Templates System Feature - Comprehensive Tests', () => {
            ...
            fields.forEach(field => {
                ...
                if (field.tag === 'select') {
                    if (field.id === 'template-energy') {
                        ...
                        ['general', 'work', 'personal', 'meeting', 'checklist'].forEach(value => {
                            const option = document.createElement('option');
                            option.value = value;
    ...
    describe('setupTemplates()', () => {
        test('should add click listener to templates button', () => {
            const addEventListenerSpy = jest.spyOn(document.getElementById('templates-button'), 'addEventListener');
        ...
        test('should add click listener to close templates modal button', () => {
            const addEventListenerSpy = jest.spyOn(document.getElementById('close-templates-modal'), 'addEventListener');
        ...
        test('should add click listener to create template button', () => {
            const addEventListenerSpy = jest.spyOn(document.getElementById('btn-create-template'), 'addEventListener');
        ...
        test('should add click listener to close template edit modal button', () => {
            const addEventListenerSpy = jest.spyOn(document.getElementById('close-template-edit-modal'), 'addEventListener');
        ...
        test('should add submit listener to template form', () => {
            const addEventListenerSpy = jest.spyOn(document.getElementById('template-form'), 'addEventListener');
        ...
        test('should add click listener to add template subtask button', () => {
            const addEventListenerSpy = jest.spyOn(document.getElementById('btn-add-template-subtask'), 'addEventListener');
    ...
    describe('openTemplateEditModal()', () => {
        ...
        test('should open modal for editing existing template', () => {
            ...
            expect(renderSubtasksSpy).toHaveBeenCalledWith([{ title: 'Subtask 1', completed: false }]);
        });
    ...
    describe('renderTemplatesList()', () => {
        ...
        test('should render templates grouped by category', () => {
            ...
            const template2 = new Template({ id: 'tmpl-2', title: 'Personal Task 1', category: 'personal' });
    ...
    describe('handleTemplateFormSubmit()', () => {
        test('should create new template', async () => {
            ...
            jest.spyOn(app.templatesManager, 'getSelectedTemplateContexts').mockReturnValue(['Home']);
    ...
    describe('Integration: Template creation workflow', () => {
        test('should complete full template creation workflow', async () => {
            ...
            app.openTemplatesModal();
            expect(document.getElementById('templates-modal').classList.contains('active')).toBe(true);

            // Open create template modal
            app.openTemplateEditModal();
            expect(document.getElementById('template-edit-modal').classList.contains('active')).toBe(true);
