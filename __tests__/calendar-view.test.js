...
describe('Calendar View Feature - Comprehensive Tests', () => {
    ...
    describe('showTasksForDate()', () => {
        test('should show alert with tasks for specific date', () => {
            ...
            expect(alertCall).toContain('1/15/2025');
            expect(alertCall).toContain('Test Task');
        ...
        test('should show "No tasks" when no tasks due on date', () => {
            ...
            expect(alertSpy).toHaveBeenCalled();
            const alertCall = alertSpy.mock.calls[0][0];
            expect(alertCall).toContain('No tasks');
        ...
        test('should only show tasks for exact date', () => {
            ...
            const alertCall = alertSpy.mock.calls[0][0];
            expect(alertCall).toContain('Task on 15th');
            expect(alertCall).not.toContain('Task on 16th');
