...
describe('DailyReviewManager', () => {
    ...
    describe('renderDailyReview', () => {
        ...
        test('should calculate tasks due this week correctly', () => {
            ...
            const match = dailyReviewContent.innerHTML.match(/This Week[\s\S]*?<div[^>]*>(\d+)<\/div>/);
        ...
        test('should calculate high priority tasks correctly', () => {
            ...
            const match = dailyReviewContent.innerHTML.match(/<div[^>]*>\s*<div[^>]*>[^<]*<\/div>\s*<div[^>]*>High Priority<\/div>/);
            expect(match).toBeTruthy();
    ...
    describe('getGreeting', () => {
        test('should return Morning before 12pm', () => {
            ...
            Date.prototype.getHours = jest.fn()
    ...
    describe('Task Filtering', () => {
        test('should exclude completed tasks from all counts', () => {
            ...
            mockState.tasks = [
                ...
                { id: '3', title: 'Another Active Task', completed: false, dueDate: today.toISOString() }
            ];
        ...
        test('should correctly identify high priority tasks (80+)', () => {
            ...
            // Look for the stat card with "High Priority" label
            const match = content.match(/<div[^>]*>\s*<div[^>]*>[^<]*<\/div>\s*<div[^>]*>High Priority<\/div>/);
            expect(match).toBeTruthy();
    ...
    describe('Edge Cases', () => {
        test('should handle tasks with no due date', () => {
            mockState.tasks = [
                { id: '1', title: 'No Date Task', completed: false, priority: 90 }
            ];
        ...
        test('should handle missing optional task properties', () => {
            ...
            const html = manager.renderDailyReviewTask({ id: '1', title: 'Minimal Task', completed: false }, 'today');
