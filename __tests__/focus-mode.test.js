...
describe('FocusPomodoroManager', () => {
    ...
    describe('enterFocusMode', () => {
        test('should show alert when no tasks available', () => {
            ...
            expect(global.alert).toHaveBeenCalledWith('No tasks available for focus mode. Create some tasks first!');
        });
        ...
        test('should show notification when entering focus mode', () => {
            ...
            expect(mockApp.showNotification).toHaveBeenCalledWith('Focus mode activated! Timer started automatically.');
        });
    ...
    describe('autoTrackTimeSpent', () => {
        test('should track time spent on focused task', async () => {
            ...
            expect(mockApp.saveTasks).toHaveBeenCalled();
            expect(mockApp.showNotification).toHaveBeenCalledWith('Tracked 5 minutes on "Focus Task"');
        });
    ...
    describe('completeTaskAndExitFocus', () => {
        test('should complete task and exit focus mode', async () => {
            ...
            expect(mockApp.showNotification).toHaveBeenCalledWith('Task completed! Timer stopped automatically.');
        });
