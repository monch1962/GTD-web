...
describe('Default Contexts DRY Compliance', () => {
    ...
    test('should not have hardcoded context arrays in JavaScript files', () => {
        ...
        jsFiles.forEach(filePath => {
            ...
            for (const match of matches) {
                ...
                if (arrayStr.includes('@home') || arrayStr.includes('@work') ||
                    arrayStr.includes('@personal') || arrayStr.includes('@computer') ||
                    arrayStr.includes('@phone') || arrayStr.includes('@errand')) {
                    violations.push({
                        file: relativePath,
                        match: arrayStr
                    });
    ...
    test('context filter should show all default contexts, not just used ones', () => {
        ...
        const hasDefaultContextsImport = appContent.includes('getDefaultContextIds()') ||
        ...
        const buildsOnlyFromTasks = methodBody.includes('this.tasks.forEach(task =>') &&
