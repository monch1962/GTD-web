...
describe('ProjectOperations - Archive Project', () => {
    ...
    describe('archiveProject()', () => {
        ...
        test('should show notification', async () => {
            ...
            expect(mockApp.showNotification).toHaveBeenCalledWith('Project "Active Project" archived');
        });
...
describe('ProjectOperations - Restore Project', () => {
    ...
    describe('restoreProject()', () => {
        ...
        test('should show notification', async () => {
            ...
            expect(mockApp.showNotification).toHaveBeenCalledWith('Project "Archived Project" restored');
        });
