...
exports.ProjectModalManager = void 0
class ProjectModalManager {
    ...
    openProjectModal(project = null, pendingTaskData = null) {
        ...
        if (project) {
            ...
            document.getElementById('project-contexts').value = project.contexts
                ? project.contexts.join(', ')
                : ''
        } else {
    ...
    async saveProjectFromForm() {
        ...
        if (projectId) {
            ...
            // Create new project
            const { Project } = await Promise.resolve().then(() =>
                __importStar(require('../../models'))
            )
...
exports.ProjectModalManager = ProjectModalManager
