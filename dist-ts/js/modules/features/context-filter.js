...
exports.ContextFilterManager = void 0
...
class ContextFilterManager {
    ...
    updateSidebarContextFilters() {
        ...
        const allContexts = (0, defaultContexts_1.getAllContexts)(this.state.tasks)
        // Initialize selected contexts filter if not exists
        if (!this.state.selectedContextFilters) {
            this.state.selectedContextFilters = new Set()
        }
        ...
        const contextTaskCounts = (0, defaultContexts_1.getContextTaskCounts)(this.state.tasks)
     ...
     * @private
     */
    _createContextFilterElement(context, contextTaskCounts) {
...
exports.ContextFilterManager = ContextFilterManager
