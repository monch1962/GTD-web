...
class TaskOperations {
    ...
    constructor(state, app) {
        this.state = state
        this.app = app
        this.logger = (0, logger_1.createLogger)('TaskOperations')
    }
    /**
    ...
    async quickAddTask(title) {
        ...
        const task = new models_1.Task({
            ...
            energy: parsed.energy, // parsed.energy could be any string from parser
            time: parsed.time,
    ...
    async duplicateTask(taskId) {
        ...
        const duplicateTask = new models_1.Task(duplicatedData)
