...
exports.DailyReviewManager = void 0
...
class DailyReviewManager {
     ...
     */
    renderDailyReviewTask(task, _type) {
                    ...
                    <div class="task-meta">
                        ${
                            ...
                            <span class="task-contexts">
                                ${task.contexts.map((c) => `<span class="context-tag">${(0, dom_utils_1.escapeHtml)(c)}</span>`).join('')}
                            </span>
                        `
                                : ''
                        }
                        ${
                            ...
                            <span class="task-project">
                                ...
                                ${(0, dom_utils_1.escapeHtml)(this.getProjectTitle(task.projectId))}
                            </span>
                        `
                                : ''
                        }
...
exports.DailyReviewManager = DailyReviewManager
