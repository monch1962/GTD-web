...
exports.GlobalQuickCaptureManager = void 0
const models_1 = require('../../models')
const dom_utils_1 = require('../../dom-utils')
class GlobalQuickCaptureManager {
    ...
    renderQuickCaptureTemplates(container) {
        ...
        container.innerHTML = this.state.templates
            ...
            <button onclick="app.selectTemplateForQuickCapture('${template.id}')">
                <h4>${(0, dom_utils_1.escapeHtml)(template.title)}</h4>
                ${template.description ? `<p>${(0, dom_utils_1.escapeHtml)(template.description)}</p>` : ''}
...
exports.GlobalQuickCaptureManager = GlobalQuickCaptureManager
//# sourceMappingURL=global-quick-capture.js.map
