...
exports.DataExportImportManager = void 0
...
class DataExportImportManager {
    ...
    constructor(state, app) {
        this.state = state
        this.app = app
        this.logger = (0, logger_1.createLogger)('DataExportImport')
    }
    /**
            ...
            reader.onload = async (e) => {
                try {
                    ...
                    importData.projects.forEach((projectData) => {
                        const project = new models_2.Project(projectData)
...
exports.DataExportImportManager = DataExportImportManager
//# sourceMappingURL=data-export-import.js.map
