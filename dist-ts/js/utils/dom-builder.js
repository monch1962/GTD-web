...
exports.buildSafeTemplate = buildSafeTemplate
exports.createLink = createLink
exports.createButton = createButton
exports.createBadge = createBadge
exports.clearElement = clearElement
exports.isUnsafeHTML = isUnsafeHTML
 ...
 */
function buildSafeTemplate(strings, ...values) {
    let result = ''
 ...
 */
function createButton(text, onClick, type = 'button') {
 ...
 */
function createBadge(text, color = 'badge-secondary') {
