...
class Storage {
    constructor(userId = null) {
        ...
        this.QUOTA_WARNING_THRESHOLD = constants_1.StorageConfig.QUOTA_WARNING_THRESHOLD
    }
    async init() {
    ...
    getStorageInfo() {
        ...
        total = constants_1.StorageConfig.ESTIMATED_TOTAL_SIZE
    ...
    async freeSpace(bytesToFree) {
        ...
        if (archive.length > 0) {
            ...
            for (const entry of archive) {
                ...
                const maxAge = constants_1.StorageConfig.ARCHIVE_MAX_AGE_MS
