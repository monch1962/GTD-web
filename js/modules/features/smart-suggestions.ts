...
export class SmartSuggestionsManager {
    ...
    showSuggestions (): void {
        ...
        const timeSelect = document.getElementById('suggestion-time') as HTMLSelectElement | null
    ...
    selectSuggestedTask (taskId: string): void {
        ...
        setTimeout(() => {
            ...
            if (taskElement) {
                ...
                ;(taskElement as HTMLElement).style.animation = 'pulse 0.5s ease-in-out 3'
            }
        }, 100)
    }
}
