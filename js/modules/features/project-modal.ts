    ...
    openProjectModal(
        ...
        if (project) {
            ...
            ;(document.getElementById('project-description') as HTMLTextAreaElement).value =
                project.description || ''
            ;(document.getElementById('project-status') as HTMLSelectElement).value =
                project.status || 'active'
            ;(document.getElementById('project-contexts') as HTMLInputElement).value =
                project.contexts ? project.contexts.join(', ') : ''
        } else {
