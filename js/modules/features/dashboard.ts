...
export class DashboardManager {
    ...
    renderDashboard(): void {
        ...
        const contextCompletion: Record<string, ContextCompletion> = {}
        ...
        this.state.tasks.forEach((task) => {
            if (task.energy && energyStats[task.energy as keyof EnergyStats]) {
                energyStats[task.energy as keyof EnergyStats].total++
                if (task.completed) energyStats[task.energy as keyof EnergyStats].completed++
            }
        })
