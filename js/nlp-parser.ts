...
export class TaskParser {
    private contextPattern: RegExp
    private energyPattern: RegExp
    private timePattern: RegExp
    private recurrencePattern: RegExp
    ...
    constructor () {
        ...
        this.recurrencePattern =
            /\b(daily|weekly|monthly|yearly|every day|every week|every month|every year|recurring)\b/i
    ...
    parse (input: string): ParsedTaskData {
        ...
        result.title = this.removeFromTitleByPattern(
            result.title,
            this.energyPattern,
            result.energy
        )
        ...
        result.title = this.removeFromTitleByPattern(
            result.title,
            this.timePattern,
            result.time + '(?:min|minutes?|hrs?|hours?|h)'
        )
